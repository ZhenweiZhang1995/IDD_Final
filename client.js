...
socket.on('detectDogs', function(msg) { 
  document.getElementById("message").innerHTML = "Your dog is here";
});

socket.on('noDog', function(msg) { 
  document.getElementById("message").innerHTML = "Your dog is not detected";
});
